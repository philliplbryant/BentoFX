...
public sealed interface DockEvent {
	 ...
	 */
	record RootContainerAdded(@NotNull DockContainer container) implements DockEvent {}
	 ...
	 */
	record RootContainerRemoved(@NotNull DockContainer container) implements DockEvent {}
	 ...
	 */
	record ContainerParentChanged(@NotNull DockContainer container, @Nullable DockContainerBranch priorParent,
	 ...
	 */
	record ContainerChildAdded(@NotNull DockContainerBranch container,
	                           @NotNull DockContainer child) implements DockEvent {}
	 ...
	 */
	record ContainerChildRemoved(@NotNull DockContainerBranch container,
	                             @NotNull DockContainer child) implements DockEvent {}
	 ...
	 * 		Dockable added.
	 */
	record DockableAdded(@NotNull DockContainerLeaf container, @NotNull Dockable dockable) implements DockEvent {}
	...
	final class DockableClosing implements DockEvent {
		private final @NotNull Dockable dockable;
		private final @NotNull DockContainerLeaf container;
		 ...
		 */
		public DockableClosing(@NotNull Dockable dockable, @NotNull DockContainerLeaf container) {
	 ...
	 */
	record DockableRemoved(@NotNull Dockable dockable, @NotNull DockContainerLeaf container) implements DockEvent {}
	 ...
	 * 		Container the dockable belongs to.
	 */
	record DockableSelected(@NotNull Dockable dockable, @NotNull DockContainerLeaf container) implements DockEvent {}
	 ...
	 */
	record DockableParentChanged(@NotNull Dockable dockable, @Nullable DockContainerLeaf priorParent,
