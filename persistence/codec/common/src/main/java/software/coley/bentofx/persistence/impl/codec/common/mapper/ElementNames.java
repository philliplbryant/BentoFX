...
public class ElementNames {
    ...
    public static final String ROOT_BRANCHES_ELEMENT_NAME = "rootBranches";
    public static final String ROOT_BRANCH_ELEMENT_NAME = "rootBranch";
    public static final String DIVIDER_POSITIONS_ELEMENT_NAME = "dividerPositions";
    public static final String DIVIDER_ELEMENT_NAME = "divider";
    public static final String BRANCHES_ELEMENT_NAME = "branches";
    public static final String BRANCH_ELEMENT_NAME = "branch";
    public static final String LEAVES_ELEMENT_NAME = "leaf";
    public static final String LEAF_ELEMENT_NAME = "leaf";
    public static final String DOCKABLES_ELEMENT_NAME = "dockables";
