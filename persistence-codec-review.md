...
Nothing here is fixed yet. Every finding below is open.
...
| | Finding | Status |
|---|---|---|
| [B1](#b1) | A root branch encodes at most one leaf child; the rest are silently dropped and the survivors reordered | **Open** |
| [B2](#b2) | `decode` lets unchecked exceptions escape, so a missing identifier surfaces as a bare `NullPointerException` | **Open** |
